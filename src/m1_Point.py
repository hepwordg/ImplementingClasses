...
class Point(object):
    ...
    def move_to(self, dx, dy):
        ...
        self.distance_travelled = self.distance_travelled + self.get_distance_from(p1)

    def move_by(self, dx, dy):
        """ Moves this point by the submitted x-y values. """
        self.x = self.x + dx
        self.y = self.y + dy
        self.total = self.total + 1
    ...
    def get_number_of_moves_made(self):
        """ Detects the number of times move_to or move_by is put into effect. """
        return self.total
    ...
    def get_distance_from_start(self):
        ...
        return self.get_distance_from(p1)

    def get_distance_traveled(self):
        return self.distance_travelled

    def closer_to(self, a, b):
        if self.get_distance_from(a) > self.get_distance_from(b):
            return b
        else:
            return a

    def halfway_to(self, a):
        return Point((a.x + self.x) / 2, (a.y + self.y) / 2)
